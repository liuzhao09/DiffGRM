...
class DIFF_GRM_V1Tokenizer(AbstractTokenizer):
    """
    ...
    def __init__(self, config: dict, dataset: AbstractDataset):
        ...
        super(DIFF_GRM_V1Tokenizer, self).__init__(config, dataset)
        ...
        from genrec.models.DIFF_GRM_V1.collate import collate_fn_train, collate_fn_val, collate_fn_test
        self.collate_fn = {
    ...
    def _encode_sent_emb(self, dataset: AbstractDataset, output_path: str):
        ...
        assert self.config['metadata'] == 'sentence', \
            'DIFF_GRM_V1Tokenizer only supports sentence metadata.'
    ...
    def encode_decoder_input(self, target_item):
        ...
        if target_item in self.item2tokens:
            ...
            # 未知商品
            decoder_input = [self.pad_token] * 4  # 长度4
