...
class DIFF_GRM_V1Trainer:
            ...
            if (epoch + 1) >= eval_start_epoch and (epoch + 1) % self.config['eval_interval'] == 0:
                ...
                if self.accelerator.is_main_process:
                    ...
                    if 'weighted_score' in all_results:
                        ...
                        self.log(f'[Epoch {epoch + 1}] Weighted Score Details: NDCG@10={ndcg_10:.4f}*0.6 + RECALL@10={recall_10:.4f}*0.4 = {weighted_score:.4f}')
    ...
    def evaluate(self, dataloader, split='test'):
        ...
        evaluator = DIFF_GRM_V1Evaluator(self.config, self.tokenizer)
