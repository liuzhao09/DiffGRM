...
CUDA_VISIBLE_DEVICES=1 python main.py \
  ...
  }' > runs/sports/schedule_8seq_e10_least_8_18_21.txt 2>&1 &
```
...
CUDA_VISIBLE_DEVICES=1 python main.py \
  ...
  --normalize_after_pca=true \
  --force_regenerate_opq=true \
  --share_decoder_output_embedding=true > runs/sports/ar_rq4layer_gtepca0_2e4d_256dim_8_14_19.txt 2>&1 &
```
...
CUDA_VISIBLE_DEVICES=3 python main.py \
  ...
  --mask_schedule='{
      ...
      "eval_start_epoch_override": 10,
      "eval_interval_override": 1,
      "guided_steps": "auto",
      "guided_conf_metric": "msp",
      "guided_refresh_each_step": true
  }' > runs/beauty/schedule_least_1seq_most_8_16_13.txt 2>&1 &
